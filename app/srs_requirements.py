...
FUNCTIONAL_REQUIREMENTS = [
    {
        ...
        "description": "Register as Patient or Healthcare Provider with credentials, security question, and consent.",
        "panel": "user",
    },
    {
        "id": "FR-02",
        ...
        "description": "Secure login for User Panel (patients and providers) with role-based access control.",
        "panel": "user",
    },
    {
        "id": "FR-02",
        ...
        "description": "Administrator login with owner access code and role enforcement.",
        "panel": "admin",
    },
    {
        "id": "FR-03",
        ...
        "description": "Recover password via security question or email verification link.",
        "panel": "user",
    },
    {
        "id": "FR-04",
        ...
        "description": "Change password; current password required for verification.",
        "panel": "both",
    },
    {
        "id": "FR-05",
        ...
        "description": "Update contact information and baseline physical metrics for all roles.",
        "panel": "both",
    },
    {
        "id": "FR-06",
        ...
        "description": "Enter glucose, blood pressure, BMI, age, and lifestyle habits; generate risk level with confidence score.",
        "panel": "user",
    },
    {
        "id": "FR-07",
    ...
    },
    {
        ...
        "description": "Providers review assigned patients, predictions, and add clinical notes.",
        "panel": "user",
    },
    {
        "id": "FR-14",
    ...
    },
    {
        ...
        "uc": "UC_07",
        "title": "Logout",
        "description": "Secure session termination for all roles.",
        "panel": "both",
    },
    {
        "id": "FR-16",
...
FR_BY_ENDPOINT = {
    ...
    "auth.register_admin": {
        ...
        "description": "Register system administrator with owner access code.",
        "panel": "admin",
    },
    ...
    "admin.admin_dashboard": {
        ...
        "description": "System monitoring, dataset workflow, model training, and user management.",
        "panel": "admin",
    },
}
